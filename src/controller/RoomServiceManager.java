 ...
 * between the view classeses - "AdminView" and "OrderView" and the model classes - "MenuItem" and "Order"
 * 
 * It can create an order or customize the menu.
 * Both functionalities are included in the same class "RoomServiceManager" to ensure that any changes to the menu will be reflected during
...
public class RoomServiceManager {
     ...
     * @return returns true if menu item is successfully added to the order/ returns false if menu item fails to be added (order Id is invalid/ menu item name entered does not exist in menu database)
     */
     ...
     * @return returns true if menu item is successfully removed from the order/ returns false if menu item fails to be removed (order Id is invalid/ menu item name entered does not exist in order or menu database)
     */
     ...
     * @param orderId Order Id of the order
     * @return returns true if updating of order is successfull/ returns false id updating of order fails (Order Id is not in database)
     */
     ...
     * 
     * @param orderId Order Id of the order
     * @return returns true if order Id is found in the database/ returns false if order Id is not found in database
     */
     ...
     * @return returns Order object if there is an order made/ returns null if no order made
     */
     ...
     * @return returns true if menu item is added successfully/ return falls if menu item fails to be added(Duplicated menu item)
     */
     ...
     * @return returns true if menu item is updated successfully/ return falls if menu item fails to be updated(menu item not found in database)
     */
     ...
     * @return returns the menu item id if menu item found/returns empty string if menu item not found
     */
    ...
    /**
     * Finds the menu item based on the item name
     * 
     * @param name Name of menu item to be found
     * @return returns the menu item object if the menu item is found/ returns null if the menu item is not found
     */
